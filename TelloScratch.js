 ...
 (function(ext) {
   // /home/pi/code/TelloScratch/TelloScratch.js
   ...
   var getData = 'ERROR'; // initial set to ERROR 
   ...
   ext.cnct = function() {	
	...
	server.on("message", function (received, rinfo) {
		getData = received; 
		console.log("server got: " + received + " from " +
    ...
    server.bind(listenerPort,listenerHOST);
